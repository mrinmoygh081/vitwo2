...
const Counter = () => {
  ...
  return (
    ...
    <div className="container-fluid my-5 py-5">
        ...
        <div className="row boxed-area py-5 px-3 Counter_max_width1 my-5">
          <div className="col-lg-3 col-md-3 col-12 text-center box_right_border">
