        ...
        <div className="col-md-6 col-12">
          <div>
            <div className="ethicsethos">
              ...
              <ul>
                <li><i class="fa-solid fa-chevron-right"></i> &nbsp; Integrity &amp; Professionalism</li>
                <li><i class="fa-solid fa-chevron-right"></i> &nbsp; Energy, Enthusiasm &amp; Passion</li>
                <li><i class="fa-solid fa-chevron-right"></i> &nbsp; Leading by Example and Doing things Right.</li>
                <li><i class="fa-solid fa-chevron-right"></i> &nbsp; Respect for Others &amp; Working Together and Building Relationship.</li>
                <li><i class="fa-solid fa-chevron-right"></i> &nbsp; Commitment &amp; Openness in Communication.</li>
              </ul>
            </div>
