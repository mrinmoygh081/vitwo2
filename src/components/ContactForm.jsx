            ...
            <section className="section-map section-map-right">
                ...
                <div class="container desk_abs">
                    ...
                    <div class="icon-links icon-social icon-links-grid social-colors">
                        <a class="facebook"><i class="fa-brands fa-facebook-f icon-facebook"></i></a>
                        <a class="twitter"><i class="fa-brands fa-twitter icon-twitter"></i></a>
                        <a class="instagram"><i class="fa-brands fa-instagram icon-instagram"></i></a>
                        <a class="pinterest"><i class="fa-brands fa-pinterest-p icon-pinterest"></i></a>
                    </div>
                </div>
            </section>
